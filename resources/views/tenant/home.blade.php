...
<body>
    <header class="topbar py-3">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <span class="badge px-3 py-2">{{ $tenant->domain }}</span>
        </div>
    </header>
    ...
    <main class="container py-4 py-md-5">
        <section class="hero-card">
            <div class="hero-head">
                <h1 class="h4 mb-1">{{ $tenant->business_name ?? $tenant->tenant_id }}</h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="meta-chip">
                            ...
                            <div class="value">{{ ucfirst($tenant->plan ?? 'basic') }}</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="meta-chip">
                            <div class="label">Tenant ID</div>
                            <div class="value">{{ $tenant->tenant_id }}</div>
                        </div>
                    </div>
                </div>
            </div>
