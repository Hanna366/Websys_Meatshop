            ...
            <header class="tenant-header sticky top-0 z-30 px-4 py-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="heading-font mb-0 text-2xl font-semibold tracking-tight text-slate-900"><?php echo $__env->yieldContent('page_title', 'Tenant Dashboard'); ?></h1>
...
<?php /**PATH C:\Users\Rusty\Music\Websys_Meatshop\resources\views/layouts/tenant.blade.php ENDPATH**/ ?>