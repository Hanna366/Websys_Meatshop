        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('tenants.updateStatus', $tenant->tenant_id)); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-2">
                            <label class="form-label">Domain</label>
                            <input type="text" name="domain" class="form-control" value="<?php echo e($tenant->domain); ?>" placeholder="ramcar.localhost">
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="suspended_message" class="form-control" value="<?php echo e($tenant->suspended_message ?? 'Please contact your administrator.'); ?>">
                        </div>
...
<?php echo $__env->make('layouts.central', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\OWNER\Documents\webs\meatshop\resources\views/tenants/show.blade.php ENDPATH**/ ?>