...
<body>
    ...
    <nav class="navbar">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <div class="auth-buttons">
                ...
                <a href="<?php echo e(route('tenants.create')); ?>" class="btn-signup">
    ...
    <div class="hero">
        ...
        <div class="cta-buttons">
            <a href="<?php echo e(route('tenants.create')); ?>" class="btn-primary">
...
<?php /**PATH C:\Users\OWNER\Documents\webs\meatshop\resources\views/central/welcome.blade.php ENDPATH**/ ?>