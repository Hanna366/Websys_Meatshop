        ...
        <article class="group rounded-2xl border border-slate-200/70 bg-white p-5 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-xl">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="heading-font text-3xl font-semibold text-slate-900"><?php echo e($stats['total_tenants'] ?? 0); ?></h3>
                </div>
        ...
        <article class="group rounded-2xl border border-slate-200/70 bg-white p-5 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-xl">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="heading-font text-3xl font-semibold text-emerald-700"><?php echo e($stats['active_tenants'] ?? 0); ?></h3>
                </div>
        ...
        <article class="group rounded-2xl border border-slate-200/70 bg-white p-5 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-xl">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="heading-font text-3xl font-semibold text-amber-600"><?php echo e($stats['suspended_tenants'] ?? 0); ?></h3>
                </div>
        ...
        <article class="group rounded-2xl border border-slate-200/70 bg-white p-5 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-xl">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <h3 class="heading-font text-3xl font-semibold text-rose-600"><?php echo e($stats['unpaid_tenants'] ?? 0); ?></h3>
                </div>
...
<?php echo $__env->make('layouts.central', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rusty\Music\Websys_Meatshop\resources\views/central/home.blade.php ENDPATH**/ ?>