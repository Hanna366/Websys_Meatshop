...
<section class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <article class="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-card">
            ...
            <p class="mt-2 text-2xl font-bold text-slate-900"><?php echo e(number_format((int) data_get($inventoryStats ?? [], 'total_products', 0))); ?></p>
        ...
        <article class="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-card">
            ...
            <p class="mt-2 text-2xl font-bold text-amber-600"><?php echo e(number_format((int) data_get($inventoryStats ?? [], 'low_stock_products', 0))); ?></p>
        ...
        <article class="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-card">
            ...
            <p class="mt-2 text-2xl font-bold text-emerald-600"><?php echo e(number_format((int) data_get($inventoryStats ?? [], 'healthy_stock_products', 0))); ?></p>
        ...
        <article class="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-card">
            ...
            <p class="mt-2 text-2xl font-bold text-indigo-600">PHP <?php echo e(number_format((float) data_get($inventoryStats ?? [], 'total_value', 0), 2)); ?></p>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                ...
                <tbody id="inventoryTable" class="divide-y divide-slate-100 text-slate-700">
                    <?php $__empty_1 = true; $__currentLoopData = ($inventoryProducts ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-3"><?php echo e(number_format($stock, 2)); ?></td>
                            <td class="px-3 py-3"><?php echo e(number_format($reorderLevel, 2)); ?></td>
                            ...
                            <td class="px-3 py-3"><?php echo e(optional($product->updated_at)->format('Y-m-d H:i') ?? '-'); ?></td>
                            <td class="px-3 py-3 text-right"><button onclick="addStock('<?php echo e(addslashes((string) $product->name)); ?>')" class="rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-slate-50">+ Stock</button></td>
                        </tr>
