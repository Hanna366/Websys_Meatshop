            ...
            <tbody class="divide-y divide-slate-100 text-slate-700">
                ...
                <tr class="tenant-row transition duration-150 hover:bg-indigo-50/40">
                    ...
                    <td class="px-5 py-4 text-right">
                        ...
                        <a href="{{ route('support_tickets.show', $ticket->id) }}" class="inline-flex items-center gap-1 rounded-xl border border-indigo-200 px-3 py-2 text-sm font-semibold text-indigo-700 transition hover:-translate-y-0.5 hover:border-indigo-300 hover:bg-indigo-50">
