...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (empty($tableNames)) {
            throw new Exception('config/permission.php not loaded. Run php artisan config:clear and retry.');
        }

        if ($teams && empty($columnNames['team_foreign_key'] ?? null)) {
            throw new Exception('team_foreign_key missing in permission config.');
        }
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new Exception('config/permission.php not loaded. Drop permission tables manually.');
        }
