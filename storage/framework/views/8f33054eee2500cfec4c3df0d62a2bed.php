    ...
    <main class="mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center p-4 sm:p-6">
        <section class="w-full max-w-md rounded-2xl border border-slate-200/70 bg-white/95 p-6 shadow-xl backdrop-blur sm:p-8">
            <div class="mb-6 text-center">
                <div class="mx-auto mb-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-100 text-indigo-700">
                    <i data-lucide="store" class="h-6 w-6"></i>
                </div>
                <h1 class="heading-font text-2xl font-semibold text-slate-900">MeatShop POS</h1>
