...
<div class="card-box">
    ...
    <?php if(session('reset_link')): ?>
        <div class="alert alert-info">
            ...
            <a href="<?php echo e(session('reset_link')); ?>" class="small"><?php echo e(session('reset_link')); ?></a>
        </div>
    <?php endif; ?>
...
<?php /**PATH C:\Users\OWNER\Documents\webs\meatshop\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>