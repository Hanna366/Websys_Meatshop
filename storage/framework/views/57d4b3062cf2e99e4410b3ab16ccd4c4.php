    ...
    <section class="rounded-2xl border border-slate-200/70 bg-white p-6 shadow-card">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="<?php echo e($billingUrl ?? '#'); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3.5 py-2 text-sm font-medium text-slate-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 <?php echo e($billingUrl ? '' : 'pointer-events-none opacity-60'); ?>" <?php if(!$billingUrl): ?> aria-disabled="true" <?php endif; ?>>
...
<script>
    const planSelectBaseUrl = <?php echo json_encode($planSelectBaseUrl, 15, 512) ?>;
...
<?php echo $__env->make(app()->bound('tenant') ? 'layouts.tenant' : 'layouts.central', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\OWNER\Documents\webs\meatshop\resources\views/pricing.blade.php ENDPATH**/ ?>