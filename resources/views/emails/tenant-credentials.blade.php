...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; background:#f6f7fb; margin:0; padding:24px; color:#111827;">
    ...
    <tr>
      <td style="padding:20px 24px; background:linear-gradient(90deg,#0f766e,#047857); color:#fff;">
        <h1 style="margin:0; font-size:20px; font-weight:700;">Your {{ $tenantName }} account is ready</h1>
    ...
    <tr>
      <td style="padding:20px 24px;">
        ...
        <p style="margin:0 0 12px; line-height:1.5;">Your account for <strong>{{ $tenantName }}</strong> has been created. Below are the access details to sign in and finish onboarding.</p>
        ...
        <p style="margin:0 0 12px;">For security we recommend you set a new password immediately. Use the link below to set or reset your password for your {{ $tenantName }} account:</p>
        <p style="margin:0 0 18px;"><a href="{{ $resetUrl }}" style="display:inline-block;padding:10px 16px;border-radius:8px;background:linear-gradient(90deg,#0f766e,#047857);color:#fff;text-decoration:none;font-weight:600;">Set / Reset Password</a></p>
