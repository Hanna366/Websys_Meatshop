    ...
    <div class="container py-5">
        <div class="blocked-card mx-auto" style="max-width: 760px;">
            ...
            <div class="blocked-body">
                <p class="mb-2"><?php echo e($message ?? 'Please contact your administrator.'); ?></p>
                <p class="mb-0"><strong>Tenant:</strong> <?php echo e($tenant->business_name ?? $tenant->tenant_id); ?></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\OWNER\Documents\webs\meatshop\resources\views/tenant/blocked.blade.php ENDPATH**/ ?>